...
onclick="App.go('${href}')">
  <div class="movie-poster">
    ...
    <div class="movie-card-overlay">
      <div class="mco-top">
        <button class="mco-wl-btn${isFavorite(m.id) ? ' active' : ''}" type="button" onclick="event.stopPropagation();event.preventDefault();toggleFavoriteAPI('${m.id}');this.classList.toggle('active')" title="Watchlist">
